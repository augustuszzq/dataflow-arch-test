...
from modelzoo.common.pytorch.layers.AttentionLayer import MultiheadAttention_MLA
...
class TransformerDecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.self_attn = MultiheadAttention_MLA(
            d_model,
            nhead,
        ...
        if self.add_cross_attention:
            self.multihead_attn = MultiheadAttention_MLA(
                d_model,
                nhead,
                dropout=attention_dropout_rate,
                batch_first=batch_first,
